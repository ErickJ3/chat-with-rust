...
function init() {
    ...
    addRoom("chat");
    changeRoom("lobby");
    addMessage("lobby", "Chat", "Hey! Open another browser tab, send a message.", true);
    addMessage("chat", "Chat", "This is another room. Neat, huh?", true);
    ...
    newRoomForm.addEventListener("submit", (e) => {
        ...
        addMessage(room, "Chat", `Look, your own "${room}" room! Nice.`, true);
    })
